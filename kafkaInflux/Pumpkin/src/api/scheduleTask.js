...
export function checkAllTaskType() {
    return request[2].get(`/kafkaProducer_api/checkAllTaskType`);
}
export function addTaskType(entity) {
    return request[2].post(`/kafkaProducer_api/addTaskType`,entity);
}
export function deleteTaskTypeByName(entity) {
    return request[2].post(`/kafkaProducer_api/deleteTaskTypeByID`,entity);
}