            ...
            <el-row>
                <el-card class="box-card" shadow="always" style="background-color: blanchedalmond">
                    <div  slot="header" align="left">
                        ...
                        <el-row>
                            <el-col :span="8">
                                <el-button  style="color: red;font-size: small" size="mini" round>check types from instruction and input directory path</el-button>
                            </el-col>
                        </el-row>
                        <el-row :gutter="10">
                            <el-col :span="3">
                                <el-select v-model="value7" placeholder="type"  >
                                    <el-option
                                            v-for="item in taskTypes"
                                            :key="item.tid"
                                            :label="item.taskType"
                            ...
                            <el-col :span="8">
                                <el-input v-model="DirVo.dir" placeholder="please Input directory path" ></el-input>
                            </el-col>
                            <el-col :span="1">
                                <el-button type="primary" @click="changeColor" >start</el-button>
                            </el-col>
                            <el-col :span="1">
